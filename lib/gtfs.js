...
module.exports = {    
  ...
  getTripsNearby: function(lat, lon, radius, cb){
      ...
      Trip
        ...
        .exec(function (e, results) {
          if (results.length) {
            ...
            async.series(lookups, function (e, results) {
              cb(e, 'routes');
            });
          } else {
  ...
  getRoutesByStop: function(stop_id, cb){
    //gets all routes at a specific stop_id
  ...
  getStopsByTrip: function(agency_key, trip_id, direction_id, cb){
    //gets stops for one route
